...
void main(){
  late PlaySquareRootController controller;
  ...
  setUp(() async {
    controller = PlaySquareRootController();
    controller.currentQuestion = 0.obs;
  ...
  group("check level", () {
    test('should set values for MATHLEVEL.EASY', () {
      ...
      expect(controller.rangeRandom, equals(MathLevelValueMax.EASY_VALUE_SQ));
      expect(controller.levelAdd, equals(MathLevelValueMin.EASY_VALUE__MUL_ADD));
    });
    ...
    test('should set values for MATHLEVEL.MEDIUM', () {
      ...
      expect(controller.rangeRandom, equals(MathLevelValueMax.MEDIUM_VALUE_SQ));
      expect(controller.levelAdd, equals(MathLevelValueMin.MEDIUM_VALUE_MUL_ADD));
    });
    ...
    test('should set values for MATHLEVEL.HARD', () {
      ...
      expect(controller.rangeRandom, equals(MathLevelValueMax.HARD_VALUE_SQ));
      expect(controller.levelAdd, equals(MathLevelValueMin.HARD_VALUE_MUL_ADD));
    });
  });
  group("UI", () {
    test("Color level", () {
