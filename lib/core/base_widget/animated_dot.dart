...
class JumpDotAnimated extends StatefulWidget {
  const JumpDotAnimated({
    Key? key,
    this.numberOfDots = 3,
    this.colorDots = ColorResources.PRIMARY_1,
    this.sizeDots,
    this.paddingDots,
  }) : super(key: key);
          ...
          builder: (context, child) {
            return Container(
              padding: EdgeInsets.only(
                right:
                    index != widget.numberOfDots! - 1 ? widget.paddingDots ?? IZISizeUtil.setSize(percent: 0.006) : 0,
              ),
              ...
              child: Transform.translate(
                ...
                child: DotWidget(
                  ...
                  sizeDot: widget.sizeDots ?? IZISizeUtil.setSize(percent: 0.008),
                ),
              ),
            );
          },
