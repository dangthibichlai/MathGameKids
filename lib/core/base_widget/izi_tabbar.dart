            ...
            (index) => GestureDetector(
              ...
              child: Container(
                ...
                width: widthTabBar != null
                    ...
                    : IZISizeUtil.setSize(percent: .5).roundToDouble() /
                        (items.length + .5),
                decoration: BoxDecoration(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.labelMedium!.copyWith(
                          color: currentIndex == index
                              ...
                              : disbleColorText ?? ColorResources.NEUTRALS_3,
                        ),
                    maxLines: 1,
  ...
  TextStyle _getTextStyle(BuildContext context, int index) {
    if (selectedTextStyle == null) {
      return Theme.of(context).textTheme.labelMedium!.copyWith(
            color: currentIndex == index
                ? colorText ?? ColorResources.PRIMARY_3
                : disableColorText ?? ColorResources.GREY,
            fontWeight:
                    ...
                    ? Border(
                        bottom: currentIndex == index
                            ? BorderSide(
                                width: 2,
                                color:
                                    colorUnderLine ?? ColorResources.PRIMARY_3,
                              )
                            : const BorderSide(
                                width: 2,
