...
mixin IZISizeUtil {
  ...
  /// Set EdgeInsets only.
  ///
  static REdgeInsets setEdgeInsetsOnly(
      {double? bottom = 0,
      double? right = 0,
      double? left = 0,
      double? top = 0}) {
  ...
  ///
  static REdgeInsets setEdgeInsetsSymmetric(
  ...
  static TypeOfDevice getTypeOfDevice() {
    if (ScreenUtil().screenHeight <= 700) {
  ...
  static const double SPACE_2X_X = 13;
  ...
  // FONT SIZE
  static double DISPLAY_LARGE_FONT_SIZE_ANSWER = 35.sp;
  ...
  static double LABEL_MEDIUM_FONT_SIZE = 15.sp;
