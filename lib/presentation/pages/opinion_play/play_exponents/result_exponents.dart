...
class ResulExponentsPage extends GetView<ResultDecimalController> {
  const ResulExponentsPage({super.key});
              ...
              Column(
                children: [
                  Expanded(
                    child: RotatedBox(
                        quarterTurns: 2,
                        child: _screenResult(context, controller.player1, color: ColorResources.BG)),
                  ),
                  Expanded(
          ...
          Row(
            ...
            children: [
              ...
              GridViewContainer(
                onTap: () {
                  Get.back();
                  Get.toNamed(MainRouters.MULTIEXPONETS, arguments: {
