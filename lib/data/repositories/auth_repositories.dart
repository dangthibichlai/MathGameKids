...
class AuthRepository {
  ...
  Future<void> signInSocial({
    ...
    try {
      response = await _dio.post(EndPoints.signInAccount, data: data.toJson());
    } catch (e) {
  ...
  Future<void> checkDeviceHavePurchase({
    ...
    String _uri =
        '${EndPoints.users}?deviceID=${sl<SharedPreferenceHelper>().getTokenDevice}&fields=-groupAPIDenines,-groupAPIAccesses,-groupDetails,-groups,-dateOfBirth,-gender,-role,-email,-coverPhotos,-avatar,-fullName,-isDeleted,-fcmTokens,-socialType,-isEnableFCM';
    late Response response;
  ...
  Future<void> increaseFreeMessage({
    ...
    late Response response;
    final String _uri =
        '${EndPoints.users}/${sl<SharedPreferenceHelper>().getIdUser}/increase-aicount-free-messages';
